...
INTERPRETER = REPO / "lca" / "harness" / "graph" / "execute" / "interpreter.py"
PHASE_TRANSACTION = REPO / "lca" / "loop" / "transaction.py"
# governance_verdicts.py was merged into phase_governance.py; the verdict
# contract lives in the same module that consumes it.
PHASE_GOVERNANCE = REPO / "lca" / "harness" / "graph" / "governance" / "phase_governance.py"
