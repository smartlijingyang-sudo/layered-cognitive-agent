...
from lca.plugins.act.delta import handler_registry_provider as delta_handler_registry_provider
from lca.plugins.act.delta import handlers_provider as delta_handlers_provider
...
def test_delta_handler_implementations_do_not_own_registry_assembly() -> None:
    ...
    source = inspect.getsource(delta_handlers_provider)
...
def test_delta_handler_registry_module_owns_only_registry_composition() -> None:
    ...
    assert hasattr(delta_handler_registry_provider, "InMemoryDeltaHandlerRegistry")
    assert hasattr(delta_handler_registry_provider, "register_default_delta_handlers")
    source = inspect.getsource(delta_handler_registry_provider)
