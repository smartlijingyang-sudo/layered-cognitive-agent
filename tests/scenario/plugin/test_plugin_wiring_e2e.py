...
_SENSOR_PLUGINS: tuple[str, ...] = (
    ...
    "lca.plugins.sensors.workspace.artifacts",
    "lca.plugins.sensors.inbox.facts",
    "lca.plugins.sensors.team.inbox",
    "lca.plugins.sensors.workspace.instructions",
    "lca.plugins.sensors.skill.catalog",
)
