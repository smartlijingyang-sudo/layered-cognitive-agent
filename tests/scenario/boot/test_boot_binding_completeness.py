...
def test_missing_binding_error_exposes_diagnostic_fields() -> None:
    ...
    error = MissingBindingError(
        ...
        provider_hint="lca.plugins.act.effect.handler_seam",
    ...
    assert "lca.plugins.act.effect.handler_seam" in msg
    ...
    assert error.provider_hint == "lca.plugins.act.effect.handler_seam"
