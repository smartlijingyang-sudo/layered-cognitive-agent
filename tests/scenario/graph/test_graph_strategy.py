...
class TestGraphStrategyRegistration(unittest.TestCase):
    ...
    def test_graph_registered_by_default(self) -> None:
        from lca.contracts.models.team.team.coordination import STRATEGY_KEY_GRAPH
    ...
    def test_graph_requires_graph_coordination(self) -> None:
        from lca.contracts.models.team.team.coordination import STRATEGY_KEY_GRAPH, Pipeline
        from tests.support.strategy_registry import build_strategy_registry
