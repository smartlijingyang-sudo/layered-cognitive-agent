...
from lca.infrastructure.observability.events.w3c.validator import DefaultW3CValidator


def _invoke_seam_setup() -> dict[str, object]:
    from lca.plugins.observability.w3c.validator_seam import Config
    from lca.plugins.observability.w3c.validator_seam import setup as seam_setup
