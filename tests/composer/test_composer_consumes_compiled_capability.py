...
from lca.plugins.seam_definitions.team_seam import TeamSeam, TeamSeamFactory
from lca.plugins.seam_definitions.team_shared_memory import DefaultTeamSharedMemoryResolver
...
def test_team_seam_plugin_consumes_shared_memory_resolver_from_scope() -> None:
    ...
    module = REPO / "lca" / "plugins" / "seam_definitions" / "team_seam.py"
