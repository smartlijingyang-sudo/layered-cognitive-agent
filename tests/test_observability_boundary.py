...
from lca.contracts.models.observability.telemetry.telemetry_catalog import TELEMETRY_CATALOG
...
class TestExporterFaultIsolation(unittest.TestCase):
    ...
    def test_failing_exporter_does_not_break_run(self) -> None:
        ...
        from lca.infrastructure.observability import bind_backends, span
        from lca.infrastructure.observability.adapters.handles import _IsolatedExporter
        from lca.infrastructure.observability.backends.tracer_backend import OtelTracer
        from tests.support.observability_helpers import make_test_bound
