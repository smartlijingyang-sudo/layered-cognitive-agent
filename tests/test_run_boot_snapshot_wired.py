...
def test_snapshot_recorder_writes_file(monkeypatch) -> None:
    ...
    from lca.plugins.transport.webserver.handlers.runs.session.diagnostics import RunBootSnapshotRecorder
...
def test_snapshot_outdir_uses_default_when_no_locator() -> None:
    ...
    from lca.plugins.transport.webserver.handlers.runs.session.diagnostics import _snapshot_outdir_for
