...
def _invoke_seam_setup() -> dict[str, object]:
    from lca.plugins.seam_definitions.observability.run_locator import Config
    from lca.plugins.seam_definitions.observability.run_locator import setup as seam_setup
