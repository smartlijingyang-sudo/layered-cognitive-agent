...
CASES: list[tuple[str, str]] = [
    ...
    ("lca.contracts.mechanisms.content.content_addressable", "ContentAddressableStore"),
    ("lca.contracts.mechanisms.factory.factory_registry", "FactoryRegistry"),
    ...
    ("lca.infrastructure.search.skill.skill_policy", "filter_skill_search_result"),
    ("lca.infrastructure.skills.activation.activation_scope", "get_activated_skills"),
    ("lca.infrastructure.skills.bundled.bundled", "ensure_bundled_skills"),
    ("lca.infrastructure.skills.disk.disk_store", "DiskSkillPackageStore"),
    ("lca.infrastructure.skills.factory.factory", "resolve_skill_store"),
    ("lca.infrastructure.skills.format.format_routing", "skills_for_filename"),
    ("lca.infrastructure.skills.frontmatter.frontmatter", "split_frontmatter"),
    ("lca.infrastructure.skills.http.http_importer", "HttpSkillImporter"),
    ("lca.infrastructure.skills.market.market_auth", "market_auth_setup_hint"),
    ...
    ("lca.infrastructure.skills.url.url_sources", "ParsedSkillUrl"),
    ("lca.infrastructure.skills.zip.zip_security", "find_skill_markdown"),
