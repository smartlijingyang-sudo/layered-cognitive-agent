"""mv (model-visible) nodes — trust_classify, merge_messages, validate_manifest, assemble_lca_mv, perceive_build."""
...
from agent_lab.nodes.mv.perceive_build.plugin import PerceiveBuild
