"""Auto-generated surface skeleton for upstream ``extensions/tool-cordis/src/api-catalog.ts``.

Mirrors the public export surface of the upstream TypeScript source so that
``scripts/check_port_surface.py`` reports parity. Bodies raise
``NotImplementedError`` until a real Python implementation is filled in.

Upstream source: ``extensions/tool-cordis/src/api-catalog.ts``
"""
...
def queryEventApi(*args: object, **kwargs: object) -> object:
    ...
    raise NotImplementedError("port queryEventApi from extensions/tool-cordis/src/api-catalog.ts")

def queryServiceApi(*args: object, **kwargs: object) -> object:
    """Surface stub for upstream function ``queryServiceApi``."""
    raise NotImplementedError("port queryServiceApi from extensions/tool-cordis/src/api-catalog.ts")
