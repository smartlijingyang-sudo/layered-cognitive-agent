...
# Backwards-compat shim — main moved the default-file-store global into
# the composition root (gateway/bootstrap.py). Branch-side code that
# still uses this helper is the restored DSH execute path. Provide a
# thin singleton so the soft-lock surface imports cleanly.
