...
## 4. 输出
- 暴露的公共 API：2 个显式 __all__ 条目； 2 个定义符号中，2 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.infrastructure.credentials].forbidden_dependencies`**:
...
- `lca/infrastructure/credentials/sandbox_env.py`
