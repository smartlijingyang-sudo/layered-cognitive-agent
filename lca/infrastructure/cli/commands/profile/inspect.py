...
from lca.infrastructure.cli.commands.kernel._shared import render_diagnostic_trace_line

if TYPE_CHECKING:
    from lca.harness.profile.resolve.pipeline_loader import ProfilePipeline
...
def register(app: typer.Typer) -> None:
    ...
    def inspect_tree(
        ...
        from lca.harness.diagnostics.inspect.inspect import format_plugin_tree, inspect_profile_tree
    ...
    def dump_profile(
        ...
        from lca.harness.profile.resolve.resolve import dump_resolved, resolve_profile
    ...
    def why_cmd(
        ...
        from lca.harness.diagnostics.inspect.inspect import inspect_profile_tree, why_capability
    ...
    def why_plugin_cmd(
        ...
        from lca.harness.diagnostics.inspect.inspect import inspect_profile_tree, why_plugin
    ...
    def inspect_pipeline_cmd(
        ...
        """
        from lca.harness.profile.resolve.pipeline_loader import load_profile_pipeline
    ...
    def debug(
        ...
        if sub == "tree":
            ...
            async def main() -> None:
                ctx = await run_kernel(str(profile))
