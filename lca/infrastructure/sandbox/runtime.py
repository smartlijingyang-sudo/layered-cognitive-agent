...
from lca.infrastructure.sandbox.bootstrap import SANDBOX_INIT_TIMEOUT_S
from lca.infrastructure.sandbox.error_parse import classify_execution_error
from lca.infrastructure.sandbox.exec_result import sandbox_exec_result_from
from lca.infrastructure.sandbox.inspect_prelude import INSPECT_SCRIPT, parse_inspect_stdout
from lca.infrastructure.sandbox.paths import ONLYBOXES
from lca.infrastructure.sandbox.runtime_mount import (
...
class RunBoundSandboxRuntime(SandboxRuntime):
    ...
    async def _run_inspect_internal(self, *, force: bool = False) -> SandboxExecResult | None:
        ...
        from lca.infrastructure.skills.format_routing import enrich_inspect_profile
