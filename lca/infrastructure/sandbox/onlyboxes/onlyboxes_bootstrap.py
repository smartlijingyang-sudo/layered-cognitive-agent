...
from lca.contracts.models.core.execution.sandbox import SandboxResult
from lca.infrastructure.sandbox.onlyboxes.onlyboxes_artifacts import strip_artifacts
