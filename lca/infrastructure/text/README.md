...
## 3. 输入
- 当前包内 `2` 个公开模块 + `3` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：5 个显式 __all__ 条目； 3 个定义符号中，3 个为公共命名
...
- `lca/infrastructure/text/safe_boundary.py`
- `lca/infrastructure/text/truncate.py`
