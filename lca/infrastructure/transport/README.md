...
## 1. 职责
lca/infrastructure/transport. 外部世界：文件、LLM、网络、进程、存储、观测、插件内核。具体职责见各包 docstring；本 README 由脚手架生成，待包负责人补充。
...
## 9. 公共入口
`InternalTransport`, `TransportNotFoundError`, `TransportRegistry`
