...
## 3. 输入
- 当前包内 `6` 个公开模块 + `46` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：11 个显式 __all__ 条目； 46 个定义符号中，40 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.infrastructure.attachment].forbidden_dependencies`**:
...
- `lca/infrastructure/attachment/files_info.py`
- `lca/infrastructure/attachment/layout.py`
- `lca/infrastructure/attachment/normalizer.py`
- `lca/infrastructure/attachment/prompt.py`
- `lca/infrastructure/attachment/service.py`
- `lca/infrastructure/attachment/settings.py`
