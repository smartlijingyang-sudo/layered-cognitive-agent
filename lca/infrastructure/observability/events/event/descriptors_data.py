...
from lca.contracts.models.observability.telemetry.catalog import VocabDomain
...
def build_default_registry() -> InMemoryEventDescriptorRegistry:
    ...
    descriptors: list[EventDescriptor] = [
        ...
        _descriptor(
            ToolStarted,
            domain=VocabDomain.RESOURCE,
            emitter="lca.cognition.body.emit.tool_journal",
        ...
        _descriptor(
            ToolLifecycleEnded,
            domain=VocabDomain.RESOURCE,
            emitter="lca.harness.declarative.compile.phase.execution_policy",
        ...
        _descriptor(
            MemoryCommitted,
            domain=VocabDomain.EVENT,
            emitter="lca.cognition.memory.simple.memory",
