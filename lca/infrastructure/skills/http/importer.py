...
from lca.infrastructure.skills.url.sources import (
    ParsedSkillUrl,
    github_raw_url,
    is_host_allowed,
    parse_skill_url,
)
from lca.infrastructure.skills.zip.security import (
    extract_zip_bytes,
    find_skill_markdown,
    list_resource_paths,
)
    ...
    async def search_market(
        ...
        *,
        ...
        try:
            ...
            from lca.infrastructure.skills.market.auth import market_auth_setup_hint
