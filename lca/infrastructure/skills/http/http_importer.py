...
from lca.infrastructure.skills.url.url_sources import (
    ParsedSkillUrl,
    github_raw_url,
    is_host_allowed,
    parse_skill_url,
)
from lca.infrastructure.skills.zip.zip_security import (
    extract_zip_bytes,
    find_skill_markdown,
    list_resource_paths,
)
    ...
    async def search_market(
        ...
        *,
        ...
        try:
            ...
            from lca.infrastructure.skills.market.market_auth import market_auth_setup_hint
