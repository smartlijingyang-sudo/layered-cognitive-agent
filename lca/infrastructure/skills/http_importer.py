...
from lca.infrastructure.skills.marketplace import LobeHubMarketClient
from lca.infrastructure.skills.settings import SkillSettings, get_skill_settings
from lca.infrastructure.skills.url_sources import (
    ParsedSkillUrl,
    github_raw_url,
    is_host_allowed,
    parse_skill_url,
)
from lca.infrastructure.skills.zip_security import (
    extract_zip_bytes,
    find_skill_markdown,
    list_resource_paths,
)
    ...
    async def search_market(
        ...
        *,
        ...
        try:
            ...
            from lca.infrastructure.skills.market_auth import market_auth_setup_hint
