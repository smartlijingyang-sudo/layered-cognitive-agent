...
from lca.infrastructure.computer.cli.cli_json import cli_json_success
...
from lca.infrastructure.computer.office.office_plane import normalize_officecli_command
from lca.infrastructure.computer.op.op_result import ComputerOpResult, TerminalCapableSandbox
from lca.infrastructure.computer.sandbox.sandbox_computer import normalize_sandbox_path
...
from lca.infrastructure.sandbox.runtime.runtime_scope import ensure_sandbox_runtime
...
# ``lca.infrastructure.tools.contract.sandbox_contracts`` declare snake_case
...
def _re_get(kind: str) -> Any:
    ...
    if kind == "inv":
        from lca.infrastructure.tools.tool.tool_invocation_scope import get_current_tool_invocation_id
