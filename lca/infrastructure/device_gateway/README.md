# lca/infrastructure/device_gateway
...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.infrastructure.device_gateway].forbidden_dependencies`**:
...
- `lca/infrastructure/device_gateway/client.py`
