...
## 3. 输入
- 当前包内 `5` 个公开模块 + `17` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：10 个显式 __all__ 条目； 17 个定义符号中，13 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.cognition.sensors].forbidden_dependencies`**:
...
- `lca/cognition/sensors/clock.py`
- `lca/cognition/sensors/journal_backed.py`
- `lca/cognition/sensors/skill_catalog.py`
- `lca/cognition/sensors/workspace_artifacts.py`
- `lca/cognition/sensors/workspace_instructions.py`
