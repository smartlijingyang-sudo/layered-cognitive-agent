...
## 3. 输入
- 当前包内 `2` 个公开模块 + `14` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：1 个显式 __all__ 条目； 14 个定义符号中，12 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.harness.command].forbidden_dependencies`**:
