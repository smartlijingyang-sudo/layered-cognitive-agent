...
## 3. 输入
- 当前包内 `1` 个公开模块 + `4` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：3 个显式 __all__ 条目； 4 个定义符号中，3 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.harness.observability].forbidden_dependencies`**:
...
- `lca/harness/observability/assemble.py`
