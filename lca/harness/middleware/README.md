...
## 3. 输入
- 当前包内 `1` 个公开模块 + `16` 个公开符号（class / function）

## 4. 输出
- 暴露的公共 API：2 个显式 __all__ 条目； 16 个定义符号中，13 个为公共命名

## 5. 允许依赖
—

## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.harness.middleware].forbidden_dependencies`**:
