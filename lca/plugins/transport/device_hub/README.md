# lca/plugins/transport/device_hub
...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.plugins.transport.device_hub].forbidden_dependencies`**:
...
- `lca/plugins/transport/device_hub/auth.py`
- `lca/plugins/transport/device_hub/bind.py`
- `lca/plugins/transport/device_hub/hub.py`
- `lca/plugins/transport/device_hub/models.py`
