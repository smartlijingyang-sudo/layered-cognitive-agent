...
_PLUGIN_ID = "spine_reflector_kernel_loop"
_PUBLISHES: tuple[Category, ...] = (
    Category("spine.kernel.boot.start"),
    Category("spine.kernel.boot.completed"),
    Category("spine.loop.fork"),
)
...
plugin_spec: dict[str, Any] = {
    ...
    "test_suite": "tests.plugins.events.publishers.test_spine_reflector_kernel_loop",
}
