...
_HOOK_PACKAGES: tuple[str, ...] = (
    ...
    # PR-B/C — act nodes + providers + session
    ...
    # PR-D — remaining node stubs (perceive / think / reflect /
    # remember / control / llm / model_eye / model_visible / lineage /
    # event / passthrough / tool / session_log)
)
