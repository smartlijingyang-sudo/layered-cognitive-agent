# PR-D — model_eye/see node plugin marker
"""model_eye/see node stub marker for the loader.

Mirrors the agent_lab.nodes.model_eye/see node id so the graph compiler and
...
_marker = {"id": "see", "stage": "model_eye"}
_LAB_HOOKS["lab.model_eye.see"] = _marker
