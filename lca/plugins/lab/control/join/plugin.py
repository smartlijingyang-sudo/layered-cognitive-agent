# PR-D — control/join node plugin marker
"""control/join node stub marker for the loader.

Mirrors the agent_lab.nodes.control/join node id so the graph compiler and
...
_marker = {"id": "join", "stage": "control"}
_LAB_HOOKS["lab.control.join"] = _marker
