...
worker: act_constrain_node(*, inputs, from_port, to_port) -> dict[str, Artifact]
...
def act_constrain_node(
    ...
    **config: Any,
    ...
    """Typed wrapper for act_constrain_node — 原 execute 体 inline。"""
    config = dict(config)
