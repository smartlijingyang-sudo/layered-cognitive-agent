# PR-D — think/expose node plugin marker
"""think/expose node stub marker for the loader.

Mirrors the agent_lab.nodes.think/expose node id so the graph compiler and
...
_marker = {"id": "expose", "stage": "think"}
_LAB_HOOKS["lab.think.expose"] = _marker
