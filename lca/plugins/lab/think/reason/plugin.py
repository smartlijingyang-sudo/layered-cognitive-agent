# PR-D — think/reason node plugin marker
"""think/reason node stub marker for the loader.

Mirrors the agent_lab.nodes.think/reason node id so the graph compiler and
...
_marker = {"id": "reason", "stage": "think"}
_LAB_HOOKS["lab.think.reason"] = _marker
