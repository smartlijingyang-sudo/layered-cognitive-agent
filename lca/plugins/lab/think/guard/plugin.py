# PR-D — think/guard node plugin marker
"""think/guard node stub marker for the loader.

Mirrors the agent_lab.nodes.think/guard node id so the graph compiler and
...
_marker = {"id": "guard", "stage": "think"}
_LAB_HOOKS["lab.think.guard"] = _marker
