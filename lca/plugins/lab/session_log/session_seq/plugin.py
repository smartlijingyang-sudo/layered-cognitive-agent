# PR-D final 2/2 — session_log.session_seq real @plugin carrier
...
Slot id: ``lab.session_log.session_seq``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/session_seq/plugin.py replaced by this carrier
