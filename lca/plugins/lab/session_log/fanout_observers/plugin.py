# PR-D final 2/2 — session_log.fanout_observers real @plugin carrier
...
Slot id: ``lab.session_log.fanout_observers``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/fanout_observers/plugin.py replaced by this carrier
