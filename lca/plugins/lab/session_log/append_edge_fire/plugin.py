# PR-D final 2/2 — session_log.append_edge_fire real @plugin carrier
...
Slot id: ``lab.session_log.append_edge_fire``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/append_edge_fire/plugin.py replaced by this carrier
