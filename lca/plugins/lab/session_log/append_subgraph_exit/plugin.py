# PR-D final 2/2 — session_log.append_subgraph_exit real @plugin carrier
...
Slot id: ``lab.session_log.append_subgraph_exit``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/append_subgraph_exit/plugin.py replaced by this carrier
