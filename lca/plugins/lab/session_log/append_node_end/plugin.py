# PR-D final 2/2 — session_log.append_node_end real @plugin carrier
...
Slot id: ``lab.session_log.append_node_end``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/append_node_end/plugin.py replaced by this carrier
...
_CARRIER = LabCarrier(
    id="lab.session_log.append_node_end",
    stage="session_log",
    kind="EXECUTOR",
    description='Session.append(graph.node_end.v1).',
    node_id='append_node_end',
