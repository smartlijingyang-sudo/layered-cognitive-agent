# PR-D final 2/2 — session_log.consume_events real @plugin carrier
...
Slot id: ``lab.session_log.consume_events``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/consume_events/plugin.py replaced by this carrier
