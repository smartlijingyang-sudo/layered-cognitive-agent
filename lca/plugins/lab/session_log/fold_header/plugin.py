# PR-D final 2/2 — session_log.fold_header real @plugin carrier
...
Slot id: ``lab.session_log.fold_header``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/fold_header/plugin.py replaced by this carrier
