# PR-D final 2/2 — session_log.attach_sink real @plugin carrier
...
Slot id: ``lab.session_log.attach_sink``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/attach_sink/plugin.py replaced by this carrier
