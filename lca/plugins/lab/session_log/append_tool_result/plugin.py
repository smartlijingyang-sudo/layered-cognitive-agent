# PR-D final 2/2 — session_log.append_tool_result real @plugin carrier
...
Slot id: ``lab.session_log.append_tool_result``
Output capability: ``(none)``

delete-when (PR-D final 2/2):
- agent_lab/nodes/session_log/append_tool_result/plugin.py replaced by this carrier
