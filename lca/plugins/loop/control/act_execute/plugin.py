...
@plugin(
    ...
    contract=PluginContract(
        ...
        architecture=ArchitectureContract(
            group=FunctionalGroup.G6_DECISION, control_slots=(ControlSlot.ACT_EXECUTE,)
        ),
        lifecycle=LifecycleContract(allowed_scopes=(Scope.TURN,)),
        authority=AuthorityContract(grants=("decision.read", "action.execute.govern")),
        observability=EvidenceContract(descriptors=("control.act.execute.verified",)),
    ),
