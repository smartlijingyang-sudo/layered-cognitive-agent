...
# PR-2: typed control + functional_group + logic_address (ADR-0066 + ADR-0069)
_REPEAT_TOOL_CALL_CONTROL: tuple[dict, ...] = (
    {
        ...
        "failure_mode": "deny",
        "effect_class": "none",
        "reads": ["history.last_action", "history.tool_signature"],
        "emits": ["policy.gate.repeat-tool-call.denied"],
...
@plugin(
    ...
    control=_REPEAT_TOOL_CALL_CONTROL,
