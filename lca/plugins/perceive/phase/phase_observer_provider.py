...
from lca.contracts.protocols.journal.phase.phase_observation import PhaseObserver, PhaseObserverRegistry
...
@plugin(
    ...
    contract=PluginContract(
        ...
        observability=EvidenceContract(
            descriptors=(
                "lca-phase-observer-provider.checked",
                "lca-phase-observer-provider.served",
            )
        ),
    ),
    relations=(),
