...
from lca.contracts.protocols.journal.phase.phase_observation import PhaseObserverRegistry
...
@plugin(
    ...
    contract=PluginContract(
        ...
        observability=EvidenceContract(
            descriptors=(
                "lca-phase-observer-registry-seam.checked",
                "lca-phase-observer-registry-seam.served",
            )
        ),
    ),
    relations=(),
