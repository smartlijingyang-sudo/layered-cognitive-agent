...
## 3. 输入
- 当前包内 `2` 个公开模块 + `4` 个公开符号（class / function）
...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.plugins.perceive].forbidden_dependencies`**:
...
- `lca/plugins/perceive/sequential_hub.py`
- `lca/plugins/perceive/service.py`
