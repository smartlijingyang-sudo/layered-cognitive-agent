...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.plugins.factories].forbidden_dependencies`**:
...
- `lca/plugins/factories/tools.py`
- `lca/plugins/factories/transport.py`
