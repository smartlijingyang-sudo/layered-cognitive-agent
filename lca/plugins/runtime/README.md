...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.plugins.runtime].forbidden_dependencies`**:
...
- `lca/plugins/runtime/hook_registry.py`
- `lca/plugins/runtime/resume_input.py`
