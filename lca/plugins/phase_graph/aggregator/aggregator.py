# COMPAT(owner: ADR-0194, from: lca.plugins.phase_graph.aggregator.aggregator,
#        to: lca.plugins.loop.graph.nodes.aggregator.plugin,
#        delete_when: rg 'phase_graph\.aggregator' lca/ tests/ bundles/ = 0,
#        forbidden_new_usage: true)
"""Legacy re-export; SSOT is ``lca.plugins.loop.graph.nodes.aggregator.plugin``."""
