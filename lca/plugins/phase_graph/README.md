...
| ``phase_graph/stop_policy`` | ``loop/state/stop_policy/plugin.py`` |
| ``phase_graph/{registry,agent,aggregator,topology}`` | ``loop/graph/nodes/{registry,agent,aggregator,topology}/plugin.py`` |
