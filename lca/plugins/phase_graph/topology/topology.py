# COMPAT(owner: ADR-0194, from: lca.plugins.phase_graph.topology.topology,
#        to: lca.plugins.loop.graph.nodes.topology.plugin,
#        delete_when: rg 'phase_graph\.topology' lca/ tests/ bundles/ = 0,
#        forbidden_new_usage: true)
"""Legacy re-export; SSOT is ``lca.plugins.loop.graph.nodes.topology.plugin``."""
