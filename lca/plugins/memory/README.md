...
## 4. 输出
- 暴露的公共 API：6 个显式 __all__ 条目； 2 个定义符号中，2 个为公共命名
...
- `lca/plugins/memory/compaction_policy.py`
- `lca/plugins/memory/four_layer.py`
- `lca/plugins/memory/layered_retrieval.py`
- `lca/plugins/memory/null_retrieval.py`
- `lca/plugins/memory/tree_cache.py`
- `lca/plugins/memory/write_policy.py`
