...
from lca.plugins.composer.runtime.runtime.assembly import assemble_runtime_from_graph
...
def _agent_from_bound_graph(
    ...
    *,
    ...
    from lca.session.lifecycle.bind import event_session_binder_from_scope
