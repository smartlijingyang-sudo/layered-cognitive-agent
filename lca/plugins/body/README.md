...
## 3. 输入
- 当前包内 `2` 个公开模块 + `2` 个公开符号（class / function）
...
## 6. 禁止依赖
**pyproject.toml `[tool.lca.package_contracts.lca.plugins.body].forbidden_dependencies`**:
...
- `lca/plugins/body/safe_executor.py`
- `lca/plugins/body/simple.py`
