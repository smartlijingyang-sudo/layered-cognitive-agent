...
META_EVENT_PRODUCER_SEAMS: Final[tuple[MetaEventSlot, ...]] = (
    MetaEventSlot(
        ...
        closure_module="lca_kernel.events.payloads_spine",
    ...
    MetaEventSlot(
        ...
        closure_module="lca_kernel.events.payloads_spine",
        producer_seam="lca.cognition.brain.reasoner.PromptReasoner.generate_thoughts",
    ...
    MetaEventSlot(
        ...
        closure_module="lca.contracts.observability.assistant_ep_closure",
        producer_seam="lca.plugins.assistant.catalog",
        debug_run_family="assistant",
    ),
    MetaEventSlot(
        domain="integration",
        ...
        closure_module="lca.contracts.observability.composio_ep_closure",
        producer_seam="lca.infrastructure.integrations.composio.service",
