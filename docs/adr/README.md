...
| [0027](0027-orchestration-families-and-industry-slots.md) | 编排族与业界插槽 | SUPERVISOR/CHOREOGRAPHY/PEER/GRAPH 四族；gate/plane 正交；预留 routing/swarm |
| [0028](0028-multi-delegate-routing-and-peer.md) | Multi-delegate / Routing / Peer | 并行委派；RoutingState；PeerStrategy handoff+swarm |
