...
**目录直接 `.py` ≤5（6–7 预警，≥8 必拆）**；legacy 宽限期见 [cognitive-directory-discipline.md](cognitive-directory-discipline.md)。文件 ≤300 行（硬顶 400）、类 ≤150 行、函数 ≤40 行。任何越界以 ADR 为唯一豁免通道。
