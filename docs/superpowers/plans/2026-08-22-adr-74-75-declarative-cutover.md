...
**Spec:** `docs/adr/0074-plugin-everything-trimmed-implementation.md`、`docs/adr/0075-declarative-phase-graph-and-minimal-trusted-kernel.md`、`docs/specs/declarative-phase-graph-spec.md`、`docs/adr/0081-audit-implementation.md`、`docs/design/2026-08-19-cognitive-primitive-constitution-v3.md`。
...
**Files:**
- Modify: `docs/adr/0081-audit-implementation.md`
