...
- `lca/infrastructure/plane/__init__.py`
- `lca/infrastructure/plane/resolve.py`
- `lca/infrastructure/plane/scope.py` (contextvar + path audit)
- `tests/test_plane_bindings.py`

**Modify**
- `lca/infrastructure/sandbox/factory.py` — `resolve_sandbox` no longer prefers Host; override stays for real Sandbox tests
...
- `gateway/assemble.py`, `lca/application/casting.py` — `build_*_tools(bindings=)`
- `lca/infrastructure/tools/default_set.py` — eat bindings; default one face
- `tests/test_sandbox_resolver.py`, `tests/test_execution_surface.py`

## Chunk 2 — Two adapters + true paths

**Create**
- `lca/infrastructure/computer/ops.py`
- `lca/infrastructure/computer/machine.py`
- `lca/cognition/brain/prompts/machine_system_role.md`
- `tests/test_machine_computer.py`
- `tests/test_machine_path_scope.py`

**Modify**
- `lca/infrastructure/computer/runtime.py` — delete `_maybe_local`; sandbox guest only
- `lca/infrastructure/tools/computer/tool_set.py` — `ops=` + `build_machine_computer_tools`
- `lca/infrastructure/tools/computer/handlers.py` — empty path defaults to adapter root
...
- `lca/infrastructure/sandbox/surface.py` — prompt from primary `PlaneRef`
...
- `lca/infrastructure/computer/machine.py` — after write/run, publish `outputs_dir` via transport read
...
```
uv run ruff check --fix lca/contracts/models/core/plane.py lca/infrastructure/plane lca/infrastructure/computer lca/infrastructure/tools gateway host/paths.py host/exec.py host/local_shell host/client.py
