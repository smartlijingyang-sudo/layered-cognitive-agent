...
from gateway.runs.execution_environment import RunExecutionEnvironment
from gateway.runs.failure_recording import RunFailureFacts, record_run_failure
from gateway.runs.observability_binding import ensure_session_hub
...
class RunLifecycleCoordinator:
    ...
    def _format_exception(exc: Exception, session: RunSession) -> str:
        ...
        from gateway.runs.error_presentation import format_user_error
