...
from gateway.runs.api.file_reference_parsing import (
    collect_file_refs as _collect_file_refs,
)
from gateway.runs.ingest import FileFetcher, FileRef, ingest_file_refs
from gateway.runs.session.message_history import (
    extract_prior_turns,
)
from gateway.runs.session.message_text import history_plain_text as _history_plain_text
from gateway.runs.session.message_text import visible_user_text as _visible_user_text
