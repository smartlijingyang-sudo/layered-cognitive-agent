...
SEMANTIC_PHASE_CONTRACT_FILE = (
    ROOT / "lca" / "contracts" / "protocols" / "declarative" / "declarative_common.py"
)
PHASE_GRAPH_COMPILER_FILE = (
    ROOT / "lca" / "harness" / "declarative" / "graph" / "phase_graph_compiler.py"
)
EXPECTED_PHASES = (
    "perceive",
    "think",
